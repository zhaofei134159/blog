...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="<?=ADMIN_URL?>user_cate/index" class="current">用户分类管理</a>
      </div>
    </div>
            ...
            <div class="widget-box">
              <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
                ...
                <span style="line-height:35px;float:right;padding-right:20px;">
                  <a href="<?=ADMIN_URL?>user_cate/edit">
                  ...
                  <tbody>
                    <?php foreach($cates as $key=>$cate){?>
                     <tr>
                        ...
                        <td>
                            <button onclick="check_del(<?=$cate['id']?>)" class="btn btn-mini <?=($cate['is_del']==0)?'btn-success':'btn-warning'?>">
                              <?=($cate['is_del']==0)?'否':'是'?>
                            </button>
                        </td>
                        <td><?=date('Y-m-d H:i',$cate['ctime'])?></td>
                        <td><?=date('Y-m-d H:i',$cate['utime'])?></td>
                        <td style="text-align:center;"> <a href="<?=ADMIN_URL?>user_cate/edit?id=<?=$cate['id']?>">修改信息</a></td>
                      </tr>
                    <?php }?>
                  </tbody>
                </table>
