...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb">
			...
			<a href="<?=ADMIN_URL?>admin/index">管理员管理</a>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="<?=ADMIN_URL?>admin/update" onsubmit="return validateForm()" name="form" id="form" novalidate="novalidate">
							<?php if(!empty($admin)){?>
...
<script>
	function validateForm(){
		...
		if(id==''){
			...
			$.ajax({
	             type: "POST",
	             url: "<?=ADMIN_URL?>admin/check_phone",
	             async: false,
	             data: {phone:phone},
	             dataType: "json",
