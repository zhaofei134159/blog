...
<div id="content">
  	<div id="content-header">
		<div id="breadcrumb">
			...
			<a href="<?=ADMIN_URL?>admin/index" class="current">管理员管理</a>
		</div>
	</div>
		              ...
		              <tbody>
		              	<?php foreach($admins as $key=>$admin){?>
			                <tr>
			                  ...
			                  <td style="text-align:center;"> <a href="<?=ADMIN_URL?>admin/edit?id=<?=$admin['id']?>">修改信息</a></td>
			                </tr>
		                <?php }?>
		              </tbody>
		            </table>
