...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="<?=ADMIN_URL?>user_work/index" class="current">用户博客管理</a>
      </div>
    </div>
                  ...
                  <tbody>
                    <?php foreach($blogs as $key=>$blog){?>
                     <tr>
                        ...
                        <td>
                            <button onclick="check_del(<?=$blog['id']?>)" class="btn btn-mini <?=($blog['is_del']==0)?'btn-success':'btn-warning'?>">
                              <?=($blog['is_del']==0)?'否':'是'?>
                            </button>
                        </td>
                        <td><?=date('Y-m-d H:i',$blog['ctime'])?></td>
                        <td><a href="http://zf.blogfamily.ren/home/blog/<?=$blog['id']?>" target="__black">查看</a></td>
