    <footer>
     <!--    <div class="widewrapper footer">
        ...
        <div class="widewrapper copyright">
                &copy;<?=empty($blog['ctime'])?'':date('Y',$blog['ctime'])?>  更多来自 <a href="http://zf.blogfamily.ren/home/blog/<?=empty($blog['id'])?'':$blog['id']?>" target="_blank" title="<?=empty($blog['name'])?'':$blog['name']?>"><?=empty($blog['name'])?'':$blog['name']?></a>
        </div>
    </footer>
