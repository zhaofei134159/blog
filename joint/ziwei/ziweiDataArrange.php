...
class purpleStarAstrology extends common{
	...
	*/
	...
	public function lunar_calendar () {
		...
		# 使用五鼠遁时诀 计算时干
		$hourGanRule = array();
		$hourGanRule['子'] = array('甲'=>'甲', '乙'=>'丙', '丙'=>'戊', '丁'=>'庚', '戊'=>'壬', '己'=>'甲', '庚'=>'丙', '辛'=>'戊', '壬'=>'庚', '癸'=>'壬');
		$hourGanRule['丑'] = array('甲'=>'乙', '乙'=>'丁', '丙'=>'己', '丁'=>'辛', '戊'=>'癸', '己'=>'乙', '庚'=>'丁', '辛'=>'己', '壬'=>'辛', '癸'=>'癸');
		$hourGanRule['寅'] = array('甲'=>'丙', '乙'=>'戊', '丙'=>'庚', '丁'=>'壬', '戊'=>'甲', '己'=>'丙', '庚'=>'戊', '辛'=>'庚', '壬'=>'壬', '癸'=>'甲');
		$hourGanRule['卯'] = array('甲'=>'丁', '乙'=>'己', '丙'=>'辛', '丁'=>'癸', '戊'=>'乙', '己'=>'丁', '庚'=>'己', '辛'=>'辛', '壬'=>'癸', '癸'=>'乙');
		$hourGanRule['辰'] = array('甲'=>'戊', '乙'=>'庚', '丙'=>'壬', '丁'=>'甲', '戊'=>'丙', '己'=>'戊', '庚'=>'庚', '辛'=>'壬', '壬'=>'甲', '癸'=>'丙');
		$hourGanRule['巳'] = array('甲'=>'己', '乙'=>'辛', '丙'=>'癸', '丁'=>'乙', '戊'=>'丁', '己'=>'己', '庚'=>'辛', '辛'=>'癸', '壬'=>'乙', '癸'=>'丁');
		$hourGanRule['午'] = array('甲'=>'庚', '乙'=>'壬', '丙'=>'甲', '丁'=>'丙', '戊'=>'戊', '己'=>'庚', '庚'=>'壬', '辛'=>'甲', '壬'=>'丙', '癸'=>'戊');
		$hourGanRule['未'] = array('甲'=>'辛', '乙'=>'癸', '丙'=>'乙', '丁'=>'丁', '戊'=>'己', '己'=>'辛', '庚'=>'癸', '辛'=>'乙', '壬'=>'丁', '癸'=>'己');
		$hourGanRule['申'] = array('甲'=>'壬', '乙'=>'甲', '丙'=>'丙', '丁'=>'戊', '戊'=>'庚', '己'=>'壬', '庚'=>'甲', '辛'=>'丙', '壬'=>'戊', '癸'=>'庚');
		$hourGanRule['酉'] = array('甲'=>'癸', '乙'=>'乙', '丙'=>'丁', '丁'=>'己', '戊'=>'辛', '己'=>'癸', '庚'=>'乙', '辛'=>'丁', '壬'=>'己', '癸'=>'辛');
		$hourGanRule['戌'] = array('甲'=>'甲', '乙'=>'丙', '丙'=>'戊', '丁'=>'庚', '戊'=>'壬', '己'=>'甲', '庚'=>'丙', '辛'=>'戊', '壬'=>'庚', '癸'=>'壬');
		$hourGanRule['亥'] = array('甲'=>'乙', '乙'=>'丁', '丙'=>'己', '丁'=>'辛', '戊'=>'癸', '己'=>'乙', '庚'=>'丁', '辛'=>'己', '壬'=>'辛', '癸'=>'癸');

		$hourGan = $hourGanRule[$hourZhi][$solar->getLunar()->getDayGan()];
	...
	* 	解神,阴煞,天巫,天月,天福,天官,天厨,天空,蜚廉,破碎,华盖,月德,天才,天寿,天伤,天使,截空,旬空,长生,沐浴,冠带,临官,
